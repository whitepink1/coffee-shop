...
import Map from "../Components/MapCafe";
...
function View() {
    ...
    return (<><main className="h-fit relative">
        ...
        <div className="flex flex-col items-center justify-start h-[70vh] relative bg-main2 bg-cover text-center">
            <h2 className="text-6xl font-bold drop-shadow-xl inline-block text-coffee-50 py-4 text-center border-b-4">How to find us.</h2>
            <Map />
        </div>
